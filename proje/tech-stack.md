...
| :----------------- | :-------------------------- | :--------------------------------------------------------------------------------------------- |
| **Geliştirme Ortamı** | **Google IDX / AI Studio** | Bulut tabanlıdır; bilgisayara kurulum gerektirmez, Gemini ile yerleşik (native) çalışır.       |
...
| **Yapay Zeka (Beyin)**| **Gemini 1.5 Flash API** | Google AI Studio üzerinden ücretsiz erişilir. Kullanıcıya akıllı ve motivasyonel dönütler verir.|
